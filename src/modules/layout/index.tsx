...
const items = [
  ...
  getItem(<Link to="/Cards"> Prueba </Link>, '3', <TeamOutlined />),
  getItem(<Link to="/sw-characters"> Personajes SW </Link>, '4', <AndroidOutlined />),
  getItem(<Link to="/contact"> Contacto </Link>, '5', <MailOutlined />),
  getItem(<Link to="/about"> Acerda de </Link>, '8', <QuestionCircleOutlined />),
]
